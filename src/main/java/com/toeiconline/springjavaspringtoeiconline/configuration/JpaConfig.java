...
@EnableJpaRepositories(basePackages = {"com.toeiconline.springjavaspringtoeiconline.repository"})
...
public class JpaConfig {
    ...
    protected LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.toeiconline.springjavaspringtoeiconline.entity");
