                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Edit Category</h5>
                                        <form:form modelAttribute="category" action="/admin/category/edit" method="post" enctype="multipart/form-data">
                                            <form:hidden path="id_category" name="id_category" value="${category.id_category}"/>
                                            ...
                                            <div class="position-relative form-group">
                                                ...
                                                <form:input path="image" id="exampleFile" type="file" class="form-control-file" />
                                            </div>
