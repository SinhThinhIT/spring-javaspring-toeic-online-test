                                ...
                                <table class="mb-0 table table-dark">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>${answer.name}</td>
                                            <td>${answer.exam.question}</td>
                                            <td>
                                                <a href="/admin/answer/edit/${answer.id_answer}"><i class="fa fa-edit"></i></a> |
                                                <a href="/admin/answer/delete/${answer.id_answer}"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
