                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Post</h5>
                                        <form:form modelAttribute="postModel" action="/admin/post/edit" method="post" enctype="multipart/form-data">
                                            <form:hidden path="id_post" name="id_post" value="${postModel.id_post}"/>
